...
class CAR:
  ...
  KONA_E = "HYUNDAI KONA ELECTRIC 2017"
...
FEATURES = {
  ...
  "non_scc": [CAR.IONIQ, CAR.KONA, CAR.KIA_FORTE, CAR.SANTA_FE_1, CAR.KONA_E],                          # Car without SCC
}
...
DBC = {
  ...
  CAR.KONA_E: dbc_dict('hyundai_kia_generic', None),
}
